...
<?php
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->biddabd_debit_add_monthly($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
            <form action="biddabd_debit_add_monthly.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                            ...
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Equipment Costing</label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Studio Costing</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" required="required" name="studio_cost" class="form-control" id="studio_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
