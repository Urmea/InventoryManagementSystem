    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            $delete_overses_weekly_debit_id=$_GET['delete_overses_weekly_debit_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_overseas_debit_weekly($delete_overses_weekly_debit_id);
                            }
                            if(isset($msg))
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><center><a class="btn btn-danger" href="overseas_debit_show_weekly.php?data=delete&&delete_overses_weekly_debit_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
