...
<body style="overflow-y:auto;">
                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <div class="col-12 text-center text-sm-start">
                                <center><h2>BST WEEKLY TRANSACTION</h2> 
                                <h5>(CREDIT-SHOW)</h5></center>
                            </div>   
                       </div>
                    </div>
                </div>
  ...
  <?php
        ...
        if(isset($_GET['data']))
        {
            $id=$_GET['bst_credit_show_weekly_id'];
            if($_GET['data']=='delete')
            {
                $msg=$obj->delete_bst_credit_show_weekly($id);
            }
            if(isset($msg))
            {  
        }
...
<?php } ?>
            <?php
                ...
                $obj = new Show();
                $item = $obj->bst_credit_show_weekly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><center><a class="btn btn-danger" href="bst_credit_show_weekly.php?data=delete&&bst_credit_show_weekly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
