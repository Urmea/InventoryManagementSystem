                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <div class="col-12 text-center text-sm-start">
                                <center> 
                                    <h2>BIDDABD GOBAL DAILY TRANSACTION</h2> 
                                    <h5>(DEBIT-SHOW)</h5>
                                </center>
                            </div>   
                       </div>
...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
    <?php
            ...
            if(isset($_GET['data']))
            {
                $id=$_GET['biddabdgl_debit_show_daily_id'];
                if($_GET['data']=='delete')
                {
                    $msg=$obj->delete_biddabdgl_debit_show_daily($id);
                }
                if(isset($msg))
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabdgl_debit_show_daily();
            ?>
            <div class="row g-4">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabdgl_debit_show_daily.php?data=delete&&biddabdgl_debit_show_daily_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
