...
<?php
            ...
            if(isset($_GET['data']))
            {
                $id=$_GET['biddabdgl_credit_show_weekly_id'];
                if($_GET['data']=='delete')
                {
                    $msg=$obj->delete_biddabdgl_credit_show_weekly($id);
                }
                if(isset($msg))
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabdgl_credit_show_weekly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><center><a class="btn btn-danger" href="biddabdgl_credit_show_weekly.php?data=delete&&biddabdgl_credit_show_weekly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
