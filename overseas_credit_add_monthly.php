...
<body style="overflow-y:auto;">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->overseas_credit_add_monthly($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
                <form action="overseas_credit_add_monthly.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">	Social Media</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" name="social_cost" class="form-control" id="social_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
