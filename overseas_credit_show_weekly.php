    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            $mylife_myrule=$_GET['mylife_myrule_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_all($mylife_myrule);
                            }
                            if(isset($msg))
                            {
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            ...
            <?php
                ...
                $obj = new Show();
                $item = $obj->overseas_credit_show_weekly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><center><a class="btn btn-danger" href="overseas_credit_show_weekly.php?data=delete&&mylife_myrule_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
