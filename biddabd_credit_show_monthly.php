...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            $id=$_GET['biddabd_credit_show_monthly_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_biddabd_credit_show_monthly($id);
                            }
                            if(isset($msg))
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
 <br>
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabd_credit_show_monthly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                <thead style="background-color: #D61355; color: black; text-align: center;">
                                    <tr> 			
                                        ...
                                        <th scope="col">Facebook Income</th>
                                        <th scope="col">YouTube Income</th>
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <th><?php echo $element['facebook']; ?></th>
                                         <th><?php echo $element['youtube']; ?></th>
                                         <th><?php echo $element['investment']; ?></th>
                                         <td><?php echo $element['date']; ?></td>
                                         <td>
                                            <center>
                                                 <a class="btn btn-danger" href="biddabd_credit_show_monthly.php?data=delete&&biddabd_credit_show_monthly_id=<?php echo $element['id']; ?>" role="button">
