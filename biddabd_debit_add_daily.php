...
<body style="overflow-y:auto;">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->biddabd_debit_add_daily($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
            <form action="biddabd_debit_add_daily.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                            ...
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Teacher Cost</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" required="required" name="teacher_cost" class="form-control" id="teacher_cost" >
                                </div>
                            </div>
                        </div> 
                        <div class="row">
