...
<?php
            ...
            if(isset($_GET['data']))
            {
                $id=$_GET['biddabdgl_debit_show_monthly_id'];
                if($_GET['data']=='delete')
                {
                    $msg=$obj->delete_biddabdgl_debit_show_monthly($id);
                }
                if(isset($msg))
                { 
            }
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabdgl_debit_show_monthly();
            ?>
            <div class="row g-4">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabdgl_debit_show_monthly.php?data=delete&&biddabdgl_debit_show_monthly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
