...
<body style="overflow-y:auto;">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->biddabdgl_credit_add_daily($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
<form action="biddabdgl_credit_add_daily.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Student Fee</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" required="required" name="student_free" class="form-control" id="student_free" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
