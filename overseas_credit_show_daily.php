...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
            ...
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            ...
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_overseas_credit_daily($id);
                            }
                            if(isset($msg))
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            ...
            <?php
                ...
                $obj = new Show();
                $item = $obj->overseas_credit_show_daily();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><?php echo $element['client_free']; ?></td>
                                        <td><?php echo $element['date']; ?></td>
                                        <td><center><a class="btn btn-danger" href="overseas_credit_show_daily.php?data=delete&&id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
