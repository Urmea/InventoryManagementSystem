...
<?php
        ...
        if(isset($_GET['data']))
        {
            $id=$_GET['bst_credit_show_daily_id'];
            if($_GET['data']=='delete')
            {
                $msg=$obj->delete_bst_credit_show_daily($id);
            }
            if(isset($msg))
            {  
        }
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->bst_credit_show_daily();
            ?> 
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><center><a class="btn btn-danger" href="bst_credit_show_daily.php?data=delete&&bst_credit_show_daily_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
