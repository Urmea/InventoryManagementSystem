                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <div class="col-12 text-center text-sm-start">
                                <center>
                                    <h2>OVERSEAS WEEKLY TRANSACTION</h2> 
                                    <h5>(DEBIT-ADD)</h5>
                                </center>
                            </div>   
                       </div>
...
<?php
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->add_overseas_debit_weekly($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
           <form action="overseas_debit_add_weekly.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Marketing Cost</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" required="required" name="marketing_cost" class="form-control" id="marketing_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
