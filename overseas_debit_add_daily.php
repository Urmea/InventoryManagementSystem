...
<body style="overflow-y:auto;">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <?php
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->add_overseas_debit_daily($_POST);
            }
                    if(isset($msg))
                        {
            ?>
        ...
        ?>
                <div class="row g-4">
                    <form action="overseas_debit_add_daily.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Mobile Cost</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" name="mobile_cost" required="required" class="form-control" id="mobile_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    ...
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" name="visa_pro_cost" required="required" class="form-control" id="visa_pro_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
