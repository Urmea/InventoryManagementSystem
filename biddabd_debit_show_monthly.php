...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            $id=$_GET['biddabd_debit_show_monthly_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_biddabd_debit_show_monthly($id);
                            }
                            if(isset($msg))
                            { 
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabd_debit_show_monthly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                <thead style="background-color: #D61355; color: black; text-align: center;"> 	
                                    <tr> 			
                                        ...
                                        <th scope="col">Empolyee Cost</th>
                                        <th scope="col">Equipment Cost</th>
                                        <th scope="col">Studio Cost</th>
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><?php echo $element['employee_cost']; ?></td>
                                         <td><?php echo $element['equipment_cost']; ?></td>
                                         <td><?php echo $element['studio_cost']; ?></td>
                                         <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabd_debit_show_monthly.php?data=delete&&biddabd_debit_show_monthly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
