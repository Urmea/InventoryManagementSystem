...
<body style="overflow-y:auto;">
    ...
    <?php
            ...
            if(isset($_GET['data']))
            {
                $id=$_GET['bst_debit_show_daily_id'];
                if($_GET['data']=='delete')
                {
                    $msg=$obj->delete_bst_debit_show_daily($id);
                }
                if(isset($msg))
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><center><a class="btn btn-danger" href="bst_debit_show_daily.php?data=delete&&bst_debit_show_daily_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
