                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <div class="col-12 text-center text-sm-start">
                                <center> 
                                    <h2>BIDDABD GOBAL MONTHLY TRANSACTION</h2> 
                                    <h5>(CREDIT-SHOW)</h5>
                                </center>
                            </div>   
                       </div>
...
<?php
            ...
            if(isset($_GET['data']))
            {
                $id=$_GET['biddabdgl_credit_show_monthly_id'];
                if($_GET['data']=='delete')
                {
                    $msg=$obj->delete_biddabdgl_credit_show_monthly($id);
                }
                if(isset($msg))
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabdgl_credit_show_monthly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                <thead style="background-color: #D61355; color: black; text-align: center;">
                                    <tr> 			
                                        ...
                                        <th scope="col">Social Media Income</th>
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><?php echo $element['social_cost']; ?></td>
                                         <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabdgl_credit_show_monthly.php?data=delete&&biddabdgl_credit_show_monthly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
