...
<?php
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->biddabdgl_credit_add_monthly($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
<form action="biddabdgl_credit_add_monthly.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">Social Media Income</label>
                                    <input type="text" style="background-color: white; font-weight: bold; color:black;" required="required" name="social_cost" class="form-control" id="social_cost" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
