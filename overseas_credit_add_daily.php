...
<body style="overflow-y:auto;">
 ...
 <?php
            ...
            if(isset($_POST['add']))
            {
                $msg=$obj->overseas_credit_add_daily($_POST);
            }
                    if(isset($msg))
                        {
            ?>
...
?>
                <form action="overseas_credit_add_daily.php" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3"> 
                                    <label for="exampleInputEmail1" class="form-label" style="color: white;font-weight: bold;">	Client Fee</label>
                                    <input type="text" required="required" style="background-color: white; font-weight: bold; color:black;" name="client_free" class="form-control" id="client_free" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3"> 
