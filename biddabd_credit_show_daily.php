                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <div class="col-12 text-center text-sm-start">
                                <center>
                                    <h2>BIDDABD DAILY TRANSACTION</h2>  
                                    <h5>(CREDIT-SHOW)</h5>
                                </center>
                            </div>   
                       </div>
...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
            <?php
                        ...
                        if(isset($_GET['data']))
                        {
                            $id=$_GET['biddabd_credit_show_daily_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_biddabd_credit_show_daily($id);
                            }
                            if(isset($msg))
                            {  
                        }
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            ...
            <?php
                ...
                $obj = new Show();
                $item = $obj->biddabd_credit_show_daily();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                         ...
                                         <td><?php echo $element['course_free']; ?></td>
                                         <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabd_credit_show_daily.php?data=delete&&biddabd_credit_show_daily_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
