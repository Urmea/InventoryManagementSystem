...
<!-- -------------------------------Delete Function Starts here------------------------------- -->
                        ...
                        if(isset($_GET['data']))
                        {
                            $overseas_debit_monthly_id=$_GET['overseas_debit_monthly_id'];
                            if($_GET['data']=='delete')
                            {
                                $msg=$obj->delete_overseas_debit_monthly($overseas_debit_monthly_id);
                            }
                            if(isset($msg))                           
                            {
                        }
...
<!-- -------------------------------Delete Function Ends here------------------------------- -->
            ...
            <?php
                ...
                $obj = new Show();
                $item = $obj->overseas_debit_show_monthly();
            ?>
            <div class="row g-4">
                            ...
                            <table class="table table-bordered" style="border: 1px solid; border-color: white;">
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><center><a class="btn btn-danger" href="overseas_debit_show_monthly.php?data=delete&&overseas_debit_monthly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
